...
export const END_OF_RESULTS_MESSAGE = 'You reached the end of results';
export const NO_RESULTS_MESSAGE =
    'Sorry, there are to results matching your request.';
export const EMPTY_FAVORITES_MESSAGE = 'Your favorites list is empty.';
